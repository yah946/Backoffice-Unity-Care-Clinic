...
<body>
    ...
    <main class="main">
        ...
        <div class="main-btn-container">
            <button class="main-btn"><a href="insert_patient.php">New Patient</a></button>
        </div>
        <div class="main-table--flex">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "select * from patient order by id limit 7 offset $start";
                    $select_limit = mysqli_query($conn,$sql);
                    $pages=ceil(mysqli_num_rows(mysqli_query($conn,"select * from patient"))/7);
                    while($row = mysqli_fetch_assoc($select_limit)){
                        ...
                        <tr>
                            ...
                            <td>$row[address]</td>
                            <td>
                                <a class='action-button update-button' href='insert_patient.php?id=$row[id]'>update</a>
                            </td>
                            <td>
